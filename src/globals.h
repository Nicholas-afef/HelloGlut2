...
const std::string LIGHT_FRAGMENT_SHADER_PATH = "res/shaders/LightingShader.glsl";
const std::string CHECKER_TEXTURE = "resources/textures/checker_256x256.jpg";
const std::string COW_TEXTURE = "resources/textures/cow-tex-fin.jpg";